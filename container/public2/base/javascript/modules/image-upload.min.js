...
this.field_clear=$('<input type="hidden" name="clear_upload">').appendTo(this.el);this.button_url=$('<a href="javascript:;" class="btn">'+'<i class="icon-globe"></i>'+
this._('Link')+'</a>').prop('title',this._('Link to a URL on the internet (you can also link to an API)')).on('click',this._onFromWeb).insertAfter(this.input);this.button_upload=$('<a href="javascript:;" class="btn">'+'<i class="icon-cloud-upload"></i>'+
